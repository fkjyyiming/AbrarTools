...
public class MarkFloorEleAuto : IExternalCommand
{
    ...
    public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
    {
        ...
        ICollection<Element> allFloors = collector.OfCategory(BuiltInCategory.OST_Floors).WhereElementIsNotElementType().ToElements();
        ...
        using (Transaction trans = new Transaction(doc, "Set Floor Elevation Parameters"))
        {
            ...
            foreach (Floor elem in allFloors)
            {
                ...
                {
                    TaskDialog.Show("Error", $"Insufficient top surface points found for floor: {floor.Id}");
                    continue;
                }
